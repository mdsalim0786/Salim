...
<html lang="en-US">
	...
	<title>Log In &lsaquo; SHOPPIG  CLUB &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=6.2" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/e%20commerce/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://localhost/e%20commerce/wp-admin/">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
				<a rel="nofollow" href="./?action=register">Register</a> | <a href="./index.php/my-account/lost-password/index.html">Lost your password?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to SHOPPIG  CLUB</a>		</p>
			</div>
			<script id="ce4wp_form_submit-js-extra">var ce4wp_form_submit_data = {"siteUrl":".\/","url":".\/\/wp-admin\/admin-ajax.php","nonce":"7ab455d041","listNonce":"e1cf754115","activatedNonce":"5ae8ca78f2"};</script>
<script src="./wp-content/plugins/creative-mail-by-constant-contact/assets/js/block/submit.js?ver=1681295055" id="ce4wp_form_submit-js"></script>
...
<script id="wp-util-js-extra">var _wpUtilSettings = {"ajax":{"url":"\/e%20commerce\/wp-admin\/admin-ajax.php"}};</script>
<script src="./wp-includes/js/wp-util.min.js?ver=6.2" id="wp-util-js"></script>
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"0a91468d8f"};</script>
